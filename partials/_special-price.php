         ...
         <section id="special-price">
            <div class="container">
                ...
                <div id="filters" class="button-group text-right font-baloo font-size-16">
                    <button class="btn is-checked" data-filter="*">All Foods</button>
                    <?php
                ...
                <div class="grid"><!-- Grid class is when I press on the button which item I want to display -->
                    <?php array_map(function($item) use($in_cart){?>
                    <div class="grid-item border <?php echo $item['item_brand'] ?? "Brand"; ?>"> <!-- Copy from Top Sale class product font-rale-->
